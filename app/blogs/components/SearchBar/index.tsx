  ...
  return (
    <div className="container mx-auto flex justify-center">
      <div className="w-full max-w-[332px] lg:max-w-[500px] h-[50px] lg:h-[60px] rounded-[25px]  lg:rounded-full flex items-center gap-2 px-3 lg:px-5 border border-white/20 bg-white/5 backdrop-blur-sm glass-bg">
        ...
        {/* Search Button */}
        <button className="bg-[#39048A] font-inter text-white text-[12px] lg:text-[14px] rounded-[20px] h-[30px] lg:h-[40px] px-[20px] lg:px-[25px] hover:bg-[#4B0ABF] transition-colors duration-300 cursor-pointer">
          Search
        </button>
      </div>
    </div>
